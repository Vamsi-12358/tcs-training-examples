		...
		do {
			...
			case 4:
				...
				for(Employee it : emplist) {
					...
					System.out.print("Enter the id to update the salary \n");
					int k=scan.nextInt();
					System.out.print("Enter the id to update the salary");
					double s=scan.nextDouble();
				try {
					Employee updateemployee = employeeService. updateEmployeeSalary(k,s) ;
					System.out.println("Id: "+updateemployee.getId()+", Name: "+updateemployee.getName()+", Salary: "+updateemployee.getSalary());
